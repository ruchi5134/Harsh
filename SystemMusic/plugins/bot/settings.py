...
from SystemMusic.utils.decorators.admins import ActualAdminCB
from SystemMusic.utils.decorators.language import language, languageCB
from SystemMusic.utils.inline.settings import (
    auth_users_markup,
    playmode_users_markup,
    setting_markup,
    vote_mode_markup,
)
from SystemMusic.utils.inline.start import private_panel
...
async def gib_repo(client, CallbackQuery, _):
    await CallbackQuery.edit_message_media(
        InputMediaPhoto("https://files.catbox.moe/50golv.jpg", has_spoiler=True),
        reply_markup=InlineKeyboardMarkup(
            [[InlineKeyboardButton(text="𝗕𝗮𝗰𝗸", callback_data=f"go_to_start")]]
        ),
    )
